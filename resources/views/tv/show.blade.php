...
@section('container')
    <div class="tv-info border-b border-gray-800">
        <div class="div container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src={{ $tvshow['poster_path'] }} alt="joker" class="w-64 lg:w-96" style="width: 24rem">
            <div class="md:ml-24">
                ...
                <div x-data="{ isOpen: false }">
                    @if(count($tvshow['videos']['results']) > 0)
                        <div class="mt-12">
                            <button
                            @click="isOpen = true"
                            href="https://youtube.com/watch?v={{ $tvshow['videos']['results'][0]['key'] }}" class="flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
